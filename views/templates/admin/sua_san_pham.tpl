...
{block name='title'}Sửa sản phẩm{/block}
{block name='content'}
<style>
* {
...
<div class="container" style="margin-top: 50px">
  ...
  <div class="autocomplete" style="width:300px;">
    <input id="myInput" type="text" name="ten_sach_auto" value="{$sach_auto}" placeholder="Tên Sách">
  </div>
  ...
  <form action="" method="post">
    ...
    <input  class="form-control" type="text" id="ten_sach" name="ten_sach" placeholder="Tên sách" value="{$data['ten_sach']}">

    <label for="ten_sach_url">Tên sách URL</label>
    <input class="form-control" type="text" id="ten_sach_url" name="ten_sach_url" placeholder="Tên sách URL" value="{$data['ten_sach_url']}">
 ...
 <!-- (2): textarea sẽ được thay thế bởi CKEditor -->
      <label for="gioi_thieu">Giới Thiệu</label>
       <textarea class="form-control"  id="gioi_thieu" name="editor1" cols="80" rows="40">{$data['gioi_thieu']}    
       </textarea>
       
      <label for="doc_thu">Đọc thử</label>
       <textarea class="form-control"  id="doc_thu" name="doc_thu">{$data['doc_thu']}</textarea>
    ...
    <select class="form-control" id="id_loai_sach" name="id_loai_sach" >
      {foreach from=$loai_sach item=item}
          <option value="{$item->id}">{$item->ten_loai_sach}</option>
      {/foreach}
    </select>
    ...
    <select class="form-control" id="id_nha_xuat_ban" name="id_nha_xuat_ban" >
      {foreach from=$nxb item=item}
          <option value="{$item->id}">{$item->ten_nha_xuat_ban}</option>
      {/foreach}
    </select>

    <label for="so_trang">Số trang</label>
    <input class="form-control" type="text" id="so_trang" name="so_trang" placeholder="Số trang" value="{$data['so_trang']}">
    ...
    <input class="form-control" type="text" id="kich_thuoc" name="kich_thuoc" placeholder="Kích thước" value="{$data['kich_thuoc']}">
...
<div class="input-group mb-3">
  ...
  <div class="custom-file">
    <input type="file" value="{$data['hinh']}" name="hinh" class="custom-file-input form-control" id="inputGroupFile01">
  ...
  <label for="don_gia">Đơn giá</label>
    <input class="form-control" type="text" id="don_gia" name="don_gia" placeholder="Đơn giá" value="{$data['don_gia']}">

  <label for="gia_bia">Giá bìa</label>
    <input class="form-control" type="text" id="gia_bia" name="gia_bia" placeholder="Giá bìa" value="{$data['gia_bia']}">
